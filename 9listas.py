...
# Tipos de dados que armazenam múltiplos valores, mais têm diferenças importantes:
...
# Podemos converter uma tupla para uma lista e modificar os elementos.add()
...
# Quando usar tuplas?
#   - Quando queremos garantir que os valores nao sejam alterados.
#   - Para armazenar dados fixos como coordenadas, meses do ano, dias da semana, etc.add()
